...
write.table(x=posi, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Left_.txt", sep="\t", row.names=FALSE, col.names=TRUE)
write.table(x=nega, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Dere_.txt", sep="\t", row.names=FALSE, col.names=TRUE)
rm(list = ls())
...
write.table(x=posi, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Adela_.txt", sep="\t", row.names=FALSE, col.names=TRUE)
write.table(x=nega, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Atras_.txt", sep="\t", row.names=FALSE, col.names=TRUE)
rm(list = ls())

## 2.) Caracteristicas Y Etiquetado
Izqui<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Left_.txt", header=TRUE, sep="\t" ,dec=".")
Derec<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Dere_.txt",  header=TRUE, sep="\t" ,dec=".")
Adela<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Adela_.txt",  header=TRUE, sep="\t" ,dec=".")
Atras<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Atras_.txt",  header=TRUE, sep="\t" ,dec=".")
...
Temp_<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Dere_.txt",  header=TRUE, sep="\t" ,dec=".")
...
write.table(x=Car_Temp, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Derec.txt", sep="\t", row.names=FALSE, col.names=TRUE)
...
Temp_<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Left_.txt",  header=TRUE, sep="\t" ,dec=".")
...
Car_Temp<-Car_Temp[2:num_dat,]
write.table(x=Car_Temp, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Left.txt", sep="\t", row.names=FALSE, col.names=TRUE)
...
Temp_<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Adela_.txt",  header=TRUE, sep="\t" ,dec=".")
...
Car_Temp<-Car_Temp[2:num_dat,]
write.table(x=Car_Temp, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Adela.txt", sep="\t", row.names=FALSE, col.names=TRUE)
...
Temp_<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Dataset\\Atras_.txt",  header=TRUE, sep="\t" ,dec=".")
...
Car_Temp<-Car_Temp[2:num_dat,]
write.table(x=Car_Temp, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Atras.txt", sep="\t", row.names=FALSE, col.names=TRUE)
#_____________________________________________________Quieto_________________________________________________________
Car_Temp<-data.frame("GiroX"=0,"GiroY"=0,"GiroZ"=0,"Class"="Estable")
...
for (k in 1:num_dat){
  ...
  z<-data.frame("GiroX"=Carac[1],"GiroY"=Carac[2],"GiroZ"=Carac[3], "Class"="Estable")
  Car_Temp<-rbind(Car_Temp,z)
}
Car_Temp<-Car_Temp[2:num_dat,]
write.table(x=Car_Temp, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Estable.txt", sep="\t", row.names=FALSE, col.names=TRUE)
################################################# Agrupar los datos ################################################
rm(list = ls())
Carac_cmplt<- data.frame("GiroX"=0,"GiroY"=0,"GiroZ"=0,"Class"="Me_vale")
Temp<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Atras.txt", header=TRUE, sep="\t" ,dec=".")
Carac_cmplt<- rbind(Carac_cmplt,Temp)
Temp<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Adela.txt", header=TRUE, sep="\t" ,dec=".")
Carac_cmplt<- rbind(Carac_cmplt,Temp)
Temp<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Left.txt", header=TRUE, sep="\t" ,dec=".")
Carac_cmplt<- rbind(Carac_cmplt,Temp)
Temp<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Derec.txt", header=TRUE, sep="\t" ,dec=".")
Carac_cmplt<- rbind(Carac_cmplt,Temp)
Temp<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Estable.txt", header=TRUE, sep="\t" ,dec=".")
Carac_cmplt<- rbind(Carac_cmplt,Temp)
Carac_cmplt<- Carac_cmplt[2:dim(Carac_cmplt)[1],]

write.table(x=Carac_cmplt, file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Completas.txt", sep="\t", row.names=FALSE, col.names=TRUE)
rm(list = ls())
...
Atras<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Atras.txt", header=TRUE, sep="\t" ,dec=".")
Adela<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Adela.txt", header=TRUE, sep="\t" ,dec=".")
Izqui<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Left.txt", header=TRUE, sep="\t" ,dec=".")
Derec<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Derec.txt", header=TRUE, sep="\t" ,dec=".")
x <- c(max(Atras[,1]),max(Atras[,2]),max(Atras[,3]),max(Adela[,1]),max(Adela[,2]),max(Adela[,3]),max(Izqui[,1]),max(Izqui[,2]),max(Izqui[,3]),max(Derec[,1]),max(Derec[,2]),max(Derec[,3]))
max(x)
rm(list = ls())
...
imu<-read.table(file="C:\\Users\\miang\\OneDrive\\Escritorio\\Lectrura_IMU\\Datos\\Datos_Procesados\\Caracteristicas\\Carac_Completas.txt", header=TRUE, sep="\t" ,dec=".")
